...
//
//	e.innerTable.memTracker = memory.NewTracker(stringutil.MemoizeStr(func() string { return fmt.Sprintf("innerTable") }), -1)
//	e.innerTable.memTracker.AttachTo(e.memTracker)
//	e.outerTable.memTracker = memory.NewTracker(stringutil.MemoizeStr(func() string { return fmt.Sprintf("outerTable") }), -1)
